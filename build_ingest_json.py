...
def arguments(argv):
    ...
    parser.add_argument("--output_dir", type=str, help="directory where hydrologic stats netCDFs were saved", required=True)
...
if __name__ == "__main__":
    ...
    seg_ingest_json = build_injest_json(seg_ds, "seg")
    hru_ingest_json = build_injest_json(hru_ds, "hru")

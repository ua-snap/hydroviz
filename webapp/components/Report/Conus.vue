        ...
        <div class="container">
          ...
          <div class="is-size-5 mb-6 clamp">
            ...
            <p v-if="appContext == 'extremes'">
              ...
              the &lsquo;Minimum, {{ scenarioFullNames.rcp45 }}&rsquo; column
              are the minimum values across all 13 climate models for the
              {{ scenarioFullNames.rcp45 }} scenario, and the values in the
              &lsquo;Maximum, {{ scenarioFullNames.rcp85 }}&rsquo; column are
              the maximum values across all 13 climate models for the
